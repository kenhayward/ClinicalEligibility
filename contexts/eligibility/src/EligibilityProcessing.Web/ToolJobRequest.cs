...
/// <see cref="Embed"/> / <see cref="Conditions"/> is set, matching <see cref="Kind"/>.
/// The endpoint acquires the shared <see cref="RunGate"/> (so a tool job is mutually
/// exclusive with the main pipeline and the other tools) before writing, and returns
/// 202 immediately; the runner picks the same <see cref="JobId"/> up when it begins.
/// </summary>
