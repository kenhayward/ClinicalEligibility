...
public class VersionWebTests : IClassFixture<WebTests.Factory>
{
    ...
    [Fact]
    public async Task Version_endpoint_reports_0_1_14_with_schema_count()
    {
        ...
        Assert.NotNull(info);
        Assert.Equal("0.1.14", info!.Version);
