...
public class VersionWebTests : IClassFixture<WebTests.Factory>
{
    ...
    [Fact]
    public async Task Version_endpoint_reports_0_1_3_with_schema_count()
    {
        ...
        Assert.NotNull(info);
        Assert.Equal("0.1.3", info!.Version);
        Assert.Equal("2026-06-17", info.ReleaseDate);
