...
public class VersionWebTests : IClassFixture<WebTests.Factory>
{
    ...
    [Fact]
    public async Task Version_endpoint_reports_0_1_18_with_schema_count()
    {
        ...
        Assert.NotNull(info);
        Assert.Equal("0.1.18", info!.Version);
