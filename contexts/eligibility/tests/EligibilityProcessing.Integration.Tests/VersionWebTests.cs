...
public class VersionWebTests : IClassFixture<WebTests.Factory>
{
    ...
    [Fact]
    public async Task Version_endpoint_reports_0_1_7_with_schema_count()
    {
        ...
        Assert.NotNull(info);
        Assert.Equal("0.1.7", info!.Version);
