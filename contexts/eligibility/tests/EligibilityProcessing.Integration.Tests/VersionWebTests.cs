...
public class VersionWebTests : IClassFixture<WebTests.Factory>
{
    ...
    [Fact]
    public async Task Version_endpoint_reports_0_1_13_with_schema_count()
    {
        ...
        Assert.NotNull(info);
        Assert.Equal("0.1.13", info!.Version);
        Assert.Equal("2026-07-16", info.ReleaseDate);
